...
import chapter3.pathfinding.alg.astar.hw2.Seden.AStarHW;
import chapter3.pathfinding.alg.astar.hw2.Seden.EuclideanDistanceHeuristic;
import chapter3.pathfinding.alg.astar.hw2.Seden.VisibilityGraphHW;
...
public class PolygonWorld implements WorldRepresentation<Point2D>, GameEntity {
    ...
    public static void main(String[] args) {
        ...
        AStarHeuristic<Point2D> heuristic = new EuclideanDistanceHeuristic<>();

        PathfindingAlgorithm<Point2D> dijkstra =  new Dijkstra<>();
        PathfindingAlgorithm<Point2D> astarhw =  new AStarHW<>(heuristic);
