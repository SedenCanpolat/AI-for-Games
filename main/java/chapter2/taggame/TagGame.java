...
import chapter2.taggame.Seden.TSE_HW;
...
public class TagGame extends StateBasedGame {
    ...
    public static void main(String[] args) {
        ...
        TagPlayer tp3 = new TagPlayer("Mel", new StaticInfo(new Vector2D(400,450),0.0, OrientationType.VelocityBased), Color.yellow);
